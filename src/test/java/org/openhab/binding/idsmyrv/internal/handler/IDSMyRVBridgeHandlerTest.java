...
class IDSMyRVBridgeHandlerTest {
    ...
    void testSendMessageWhenConnected() throws Exception {
        ...
        java.lang.reflect.Field clientField = IDSMyRVBridgeHandler.class.getDeclaredField("gatewayClient");
    ...
    void testSendMessageWhenNotConnected() {
        ...
        assertTrue(exception.getMessage().contains("Gateway not connected"));
    }
